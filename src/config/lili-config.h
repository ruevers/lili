/* src/config/lili-config.h.  Generated from lili-config.h.in by configure.  */
/* src/config/lili-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef LILI_CONFIG_H

#define LILI_CONFIG_H
...
#define PACKAGE_BUGREPORT "http://bit.lilis"

/* Define to the full name of this package. */
#define PACKAGE_NAME "LILI Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "LILI Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "lili"
