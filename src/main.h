...
#if defined(NDEBUG)
#error "LILI cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "LILI Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
	...
	if(nHeight <= 200 && nHeight > 0) {
        nSubsidy = 1 * COIN;
	} else if (nHeight > 200 && nHeight <= 71300) {
		nSubsidy = 200 * COIN;
